...
export default function Home() {
  ...
  <div className="flex flex-col md:flex-row py-5 m-10 justify-between px-10 bg-slate-300">
  ...
  <div className="flex flex-col md:flex-row py-5 m-10 justify-between px-10 bg-red-200">
